  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "quote": parse_quote,
        "regEXP": parse_regEXP,
        "reservedWords": parse_reservedWords,
      ...
      function parse_disjunction() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result5 = parse_conjunction();
        if (result5 !== null) {
          var result6 = parse_OR();
          if (result6 !== null) {
            var result7 = parse_disjunction();
            if (result7 !== null) {
        ...
        var result4 = result3 !== null
          ? (function(d) { return { left: d[0], logic: d[1], right: d[2] }; })(result3)
          : null;
        if (result4 !== null) {
          var result2 = result4;
        } else {
      ...
      function parse_conjunction() {
        ...
        var result4 = result3 !== null
          ? (function(c) { return { left: c[0], logic: c[1], right: c[2] }; })(result3)
          : null;
        if (result4 !== null) {
          var result2 = result4;
        } else {
      ...
      function parse_query() {
        ...
        var result2 = result1 !== null
          ? (function(q) { return {key: q[1], value: q[5], operator: q[3] }; })(result1)
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
              ...
              if (result8 !== null) {
                ...
                if (result7 !== null) {
                  ...
                  if (result6 !== null) {
                    ...
                    if (input.substr(pos, 11) === "BEGINS_WITH") {
                      var result5 = "BEGINS_WITH";
                      pos += 11;
                    } else {
                      var result5 = null;
                      if (reportMatchFailures) {
                        matchFailed("\"BEGINS_WITH\"");
                      }
                    }
                    if (result5 !== null) {
                      var result0 = result5;
                    } else {
                      if (input.substr(pos, 9) === "ENDS_WITH") {
                        var result4 = "ENDS_WITH";
                        pos += 9;
                      } else {
                        var result4 = null;
                        if (reportMatchFailures) {
                          matchFailed("\"ENDS_WITH\"");
                        }
                      }
                      if (result4 !== null) {
                        var result0 = result4;
      ...
      function parse_value() {
        ...
        var result5 = parse_stringValue();
        if (result5 !== null) {
          var result0 = result5;
        } else {
          var result4 = parse_reservedWords();
          if (result4 !== null) {
            var result0 = result4;
          } else {
            var result3 = parse_numericValue();
            if (result3 !== null) {
              var result0 = result3;
            } else {
              var result2 = parse_regEXP();
              if (result2 !== null) {
                var result0 = result2;
              } else {
      ...
      function parse_regEXP() {
        ...
        var result2 = result1 !== null
          ? (function(r) { return new RegExp(r[1]); })(result1)
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_reservedWords() {
        var cacheKey = 'reservedWords@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_AND() {
        ...
        var result2 = result1 !== null
          ? (function(a) { return a.toUpperCase(); })(result1)
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_OR() {
        ...
        var result2 = result1 !== null
          ? (function(o) { return o.toUpperCase(); })(result1)
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_number() {
        ...
        var result2 = result1 !== null
          ? (function(number) { return parseFloat(number.join(""), 10); })(result1)
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
